...
public class SeguridadTest extends AbstractContainerBaseTest {
    ...
    void sec02_sqlInjection_enPassword_noProvoca500() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                ...
                .andExpect(result -> assertNotEquals(500,
                        result.getResponse().getStatus(), "SEC-02: SQL injection en password provocó 500"));
    }
    ...
    void sec03_xss_enCorreo_noProvoca500() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                ...
                .andExpect(result -> assertNotEquals(500,
                        result.getResponse().getStatus(), "SEC-03: XSS en correo provocó 500"));
    }
    ...
    void sec05_correoExtremamdamenteLargo_noProvoca500() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                ...
                .andExpect(result -> assertNotEquals(500,
                        result.getResponse().getStatus(), "SEC-05: correo gigante provocó 500"));
    }
    ...
    void sec09_loginEsPublico_noBloqueaLaPeticion() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                ...
                .andExpect(result -> assertNotEquals(403,
                        result.getResponse().getStatus(), "SEC-09: /login está bloqueado por seguridad (403)"));
    }
    ...
    void sec10_caracteresEspeciales_enPassword_noProvoca500() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                ...
                .andExpect(result -> assertNotEquals(500,
                        result.getResponse().getStatus(), "SEC-10: caracteres especiales provocaron 500"));
    }
}