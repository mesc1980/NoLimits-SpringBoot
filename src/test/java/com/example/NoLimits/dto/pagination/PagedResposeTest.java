...
class PagedResponseTest {
    ...
    class MetodosLombok {
        ...
        @Test
        @DisplayName("equals cuando ambos objetos tienen valores por defecto")
        void testEqualsTodosNulos() {
        ...
        @Test
        @DisplayName("hashCode con valores por defecto")
        void testHashCodeTodosNulos() {
        ...
        @Test
        @DisplayName("equals contenido null vs valor")
        void testEqualsContenidoNullVsValor() {
                ...
                PagedResponse<String> dto2 =
                        new PagedResponse<>();
                dto2.setContenido(List.of("A"));

                assertNotEquals(dto1, dto2);
        }

        @Test
        @DisplayName("equals mismos contenidos pero pagina distinta")
        void testEqualsContenidoIgualPaginaDistinta() {
        ...
        @Test
        @DisplayName("equals contenido y pagina iguales pero totalPaginas distinto")
        void testEqualsTotalPaginasConCamposPreviosIguales() {
        ...
        @Test
        @DisplayName("equals campos previos iguales pero totalElementos distinto")
        void testEqualsTotalElementosConCamposPreviosIguales() {
        ...
        @Test
        @DisplayName("hashCode distinto cuando cambia contenido")
        void testHashCodeContenidoDistinto() {
